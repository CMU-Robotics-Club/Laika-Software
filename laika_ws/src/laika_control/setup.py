...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/policies', ['laika_control/policies/policy.pt']),
    ],
    ...
    entry_points={
        'console_scripts': [
            'simple_joint_sin_publisher = laika_control.simple_joint_sin_publisher:main',
            ...
            'joint_rl_publisher = laika_control.joint_rl_publisher:main',
