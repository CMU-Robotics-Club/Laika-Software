#ifndef laika_simple_pid_controller__laika_simple_pid_controller_HPP_
#define laika_simple_pid_controller__laika_simple_pid_controller_HPP_
...
#include "laika_simple_pid_controller/laika_simple_pid_controller_parameters.hpp"

namespace laika_simple_pid_controller
{
using CommandType = control_msgs::msg::DynamicJointState;
class LaikaSimplePidController : public controller_interface::ControllerInterface
{
  struct Joint {
    Joint() {};
    // parameters
...
#endif  // laika_simple_pid_controller__laika_simple_pid_controller_HPP_
